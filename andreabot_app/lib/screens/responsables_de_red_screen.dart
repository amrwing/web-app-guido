...
class ResponsablesDeRedScreen extends StatefulWidget {
  const ResponsablesDeRedScreen({super.key});

  @override
  State<ResponsablesDeRedScreen> createState() =>
      _ResponsablesDeRedScreenState();
}

class _ResponsablesDeRedScreenState extends State<ResponsablesDeRedScreen> {
  ...
  @override
  void initState() {
    ApiRequests.getAllResponsablesDeRed().then((value) {
      if (value is List) {
