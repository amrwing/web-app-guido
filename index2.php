    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/js/bootstrap.bundle.min.js" integrity="sha384-pprn3073KE6tl6bjs2QrFaJGz5/SUsLqktiwsUTF55Jfv3qYSDhgCecCxMW52nD2" crossorigin="anonymous"></script>
        ...
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-item active">
                    <img class="bd-placeholder-img" src="img\FP7.jpg" width="100%">
                    <div class="container">
                    <div class="carousel-caption text-start">
                        <font color="black"><h1> Historial</h1>
                        <p>Consulta tu historial de calorías</p></font> 
                        <p><a class="btn btn-lg btn-primary" href="historialcal2.php">Consultar ahora</a></p>
                    </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="bd-placeholder-img" src="img\FP8.jpg" width="100%">

                    <div class="container">
                    <div class="carousel-caption">
                        <font color="BLACK"> <h1>Cálculo</h1>
                        <p>Calcula tu IMC</p></font>
                        <p><a class="btn btn-lg btn-primary" href="reg.php">Calcular ahora</a></p>
                    </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="bd-placeholder-img" src="img\FP6.jpg" width="100%">
                    <div class="container">
